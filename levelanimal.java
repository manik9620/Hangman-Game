...
public class levelanimal extends JFrame {
    

    private static JFrame level;
    private static int b = 0;

    public static void easyAnimal() {
        AnimalEasy obj = new AnimalEasy();
        // obj.setVisible(true);
        level.dispose();
    }

    public static void mediumAnimal() {
        AnimalMedium obj = new AnimalMedium();
        // obj.setVisible(true);
        level.dispose();
    }

    public static void hardAnimal() {
        AnimalHard obj = new AnimalHard();
        level.dispose();
    }
    ...
    //             "Hard Rules", JOptionPane.INFORMATION_MESSAGE);
    // }

    public static void hardInfo() {
    b++;
    if (b < 3) {
    JOptionPane.showMessageDialog(level, "You have 4 Chances to win the game otherwise your man will be hanged", "Hard Rules",
